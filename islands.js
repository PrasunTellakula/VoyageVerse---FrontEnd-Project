...
const locationCurrencyMap = {   "Santorini": "EUR",   "Maldives": "MVR",   "Bora Bora": "XPF",   "Bali": "IDR",   "Maui": "USD",   "Fiji": "FJD",   "Seychelles": "SCR",   "Phuket": "THB" };

// Add these styles at the beginning of the file after imports
...
// Define the submitReview function first
...
// Update the openPopup function to use setupReviewSubmission
...
// Update the review display code in both the initial load and refresh sections
    ...
    deleteBtn.addEventListener('click', async () => {
      if (confirm('Are you sure you want to delete this review?')) {
        try {
          ...
          // Create document reference using firestoreDoc
